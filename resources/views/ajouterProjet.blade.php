        						...
        						<h4 class="modal-title">Ajouter un maitre d'ouvrage</h4>
      							...
      							<div class="modal-body">
        							<div class="form-group">
        								...
        								<div class="col-lg-6">
        									<input  type="text" class="form-control" name="name_maitre_ouvrage" />
        								</div>
        							</div>
        							<div class="form-group">
        								<div class="col-lg-4 control-label">
        								...
        								<div class="col-lg-6">
        									<input  type="email" class="form-control" name="email_maitre_ouvrage" />
        								</div>
        							</div>
        							<div class="form-group">
        								<div class="col-lg-4 control-label">
        								...
        								<div class="col-lg-6">
        									<input  type="text" class="form-control" name="tel_maitre_ouvrage" />
        								</div>
        							</div>
        							<div class="form-group">
        								<div class="col-lg-4 control-label">
        								...
        								<div class="col-lg-6">
        									<input  type="text" class="form-control" name="fax_maitre_ouvrage" />
        								</div>
        							</div>
        							<div class="form-group">
        								<div class="col-lg-4 control-label">
        								...
        								<div class="col-lg-6">
        									<input  type="text" class="form-control" name="adresse_maitre_ouvrage" />
        								</div>
        							</div>
      							</div>
