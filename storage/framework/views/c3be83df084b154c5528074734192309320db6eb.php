...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('styles/circlfull.css')); ?>">
...
<body class="container" ng-app="indh">
    ...
    <script type="text/javascript" src="<?php echo e(url('scripts/progressJS.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(url('scripts/angular/services/authService.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(url('scripts/angular/factories/progressFactory.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(url('scripts/angular/controllers/configCtrl.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(url('scripts/angular/controllers/loginCtrl.js')); ?>"></script>
